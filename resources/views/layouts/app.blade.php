        ...
        <li class="dropdown user user-menu">
          ...
          @if (Auth::guest())
            <ul class="dropdown-menu dropdown-custom dropdown-menu-right">
              <li class="dropdown-header text-center">Опции</li>
              <li>
                <a href="/login">
  ...
  <aside class="left-side sidebar-offcanvas">
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        <li {{ !Request::segment(1) ? ' class=active' : null }}>
          <a href="{{ route('home') }}">
            <i class="fa fa-dashboard"></i> <span>О проекте</span>
          </a>
        </li>
        <li {{ Request::segment(1) === 'courses' ? ' class=active' : null }}>
          <a href="{{route('courses.index')}}">
            <i class="fa fa-dashboard"></i> <span>Курсы</span>
          </a>
        </li>
        <li {{ Request::segment(1) === 'myCourses' ? ' class=active' : null }}>
          <a href="{{route('courses.myCourses')}}">
            <i class="fa fa-dashboard"></i> <span>Мои курсы (избранные)</span>
          </a>
        </li>
...
<script src="{{ theme('js/plugins/bs-datetimepicker/bootstrap-datetimepicker.min.js') }}"
