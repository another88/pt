...
class UsersController extends Controller
{
  ...
  public function update(Requests\UpdateUserRequest $request, $id){
    ...
    return redirect(route('backend.users.edit', $user->id))->with('status' ,'User has been updated'. $request->input('is_admin'));
  }
  ...
  public function destroy($id)
  {
    $user = $this->users->findOrFail($id);
    $user->delete();
    return redirect(route('backend.users.index'))->with('status' ,'User was deleted');
  }
}
